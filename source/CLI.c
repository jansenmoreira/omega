...
int main(int argc, char** argv)
{
    ...
    program[3].imm_i64 = n;
    program[4].instruction = INS_JEQ;
    program[5].imm_i64 = 10ULL;
    program[6].instruction = INS_ADDI_I64;
    program[7].imm_i64 = step;
    program[8].instruction = INS_JMP;
    program[9].imm_i64 = 2ULL;
    program[10].instruction = INS_MOV_64;
    program[11].imm_i64 = (u64)&it;
    program[12].instruction = INS_HALT;
